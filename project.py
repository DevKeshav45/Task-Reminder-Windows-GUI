...
def createframelogin(s,destroy_this_window):    # basic frame creation
    ...
    bt2 = Button(window, text="Go to SignUp",command = lambda:goto_signup_clicked(window))
...
def b():
    ...
    t_label = Label(k, text="Title to Notify",font=("poppins", 10))
    ...
    but = Button(k, text="SET NOTIFICATION", font=("poppins", 10, "bold"), fg="#ffffff", bg="#528DFF", width=20,
                 relief="raised",
                 command=get_details)
